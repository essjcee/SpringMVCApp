...
public class StepByStep {
	...
	public ModelAndView show1a(HttpServletRequest request) {
		...
		result.addObject("greeting", "Hello, you requested /DemoWebAppMvc/afolder/page1a.htm");
		result.setViewName("displayGreeting");
		return result;
	}
	
	@RequestMapping("/page1a")
	public ModelAndView show1anoextension(HttpServletRequest request) {
	...
	@ModelAttribute("evertongreats")
	public Collection<String> populatePlayers() {
		Collection<String> greats = new ArrayList<String>();
		greats.add("Alan Ball");
		greats.add("Howard Kendal");
		greats.add("Neville Southall");
		greats.add("Kevin Sheedy");
		greats.add("Dixie Dean");
		greats.add("Ray Wilson");
		return greats;
	}
